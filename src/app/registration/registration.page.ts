...
export class RegistrationPage {
  ...
  private async register(username: string | null,
    ...
    this.httpClient.post<RegistrationStartResponse>('http://localhost:8080/registration/start', body)
      .subscribe(async (response) => {
        const data = {
          assertionId:"53CiGgjAc4maHatsjnzyGA==",
          publicKeyCredentialRequestOptions:{
            challenge:"4Ngq1BaCBdZs6LshjIyWB6eg6UVSk0fJ8XnGR7D8AI0",
            rpId:"webauthn-omed.hplar.ch",
            allowCredentials:{
            },
